              ...
              Builder(
                builder: (context) => IconButton(
                    onPressed: () {
                      ...
                      print("distancia");
                      print(controller.distancia);

                      print("tiempo");
                      print(controller.tiempo);
                                    ...
                                    return Container(
                                        ...
                                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                          Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                                            Text('Distancia aproximada: ${controller.distancia.toStringAsFixed(2)} km', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                                            Text('Tiempo aproximado: ${controller.tiempo.toStringAsFixed(2)} ${controller.tiempo >= 60 ? 'hrs' : 'min'}',
                                          ...
                                          Container(
                                              ...
                                              child: ElevatedButton.icon(
                                                  onPressed: () {
                                                    String urls = "${direccion?.latitud}, ${direccion?.longitud}";
                                                    googleMaps(urls);
                                                  },
                                                  icon: Icon(Icons.open_in_new),
                                                  label: Text('Visualizar ruta')))
                                        ]));
                                  });
                            })))
              ]);
